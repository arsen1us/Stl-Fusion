...
public abstract class AppBase
{
    ...
    // Метод запускается в режиме «выстрелил и забыл»
    // Мониторинг для всех существующих продуктов корзин
    public Task Watch(IServiceProvider services, CancellationToken cancellationToken = default)
    {
        ...
        // Задача, которая завершится, когда все ранее созданные task завершатся
        return Task.WhenAll(tasks);
    }
    // Отслеживание для конкретного продукта
    ...
    // Отслеживание изменений для общего кол-ва в корзине
        ...
        IServiceProvider services, string cartId, CancellationToken cancellationToken = default)
    {
        ...
        // Отслеживание изменения в корзине
